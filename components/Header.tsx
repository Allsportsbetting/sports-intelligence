...
function Header() {
  ...
  useEffect(() => {
    if (
      ...
      previousPercentage.current < 100 &&
      !isUnlocking
    ) {
            ...
            <div className="flex items-center gap-3">
                  ...
                  style={{
                    filter:
                      isUnlocked || isUnlocking
                        ...
                        : energyPercentage > 50
                        ? `drop-shadow(0 0 ${Math.min(
                            energyPercentage / 10,
                            8
                          )}px rgba(34, 211, 238, ${Math.min(
                            energyPercentage / 100,
                            0.9
                          )}))`
                ...
                >
                  ...
                  {isUnlocked ? (
                    ...
                    <path
                      ...
                      strokeLinecap="round"
                      className={
                        isUnlocking ? "text-amber-400" : "text-cyan-400"
                      }
                    />
                  )}
              ...
              {showJoinNowButton && (
                <button
                  ...
                  className="px-4 py-2 bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white font-semibold text-sm rounded-full shadow-lg shadow-amber-500/30 hover:shadow-amber-500/50 transition-all duration-300 whitespace-nowrap"
                >
                  Join Now
                </button>
              )}
      ...
      <AnimatePresence>
        {showLockerModal && (
          <>
            ...
            >
              <div
                className={`bg-gradient-to-br from-slate-900/95 to-slate-800/95 backdrop-blur-2xl border-2 rounded-3xl p-8 shadow-2xl ${
                  isUnlocked
              ...
              >
                <div className="text-center">
                  <h2
                    className={`text-3xl font-bold bg-gradient-to-r bg-clip-text text-transparent mb-4 ${
                      isUnlocked
